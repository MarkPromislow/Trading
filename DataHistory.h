...
template<typename BucketType>
int BucketHistory::initialize(unsigned bucketDuration, uint64_t beginTime, uint64_t endTime, BucketGenerator<BucketType>& bucketGenerator)
{
	...
	_bucketCnt = (endTime - beginTime - 1) / _bucketDuration + 1;
